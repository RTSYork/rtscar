...
val = read_register(REG_MFG_UID)
print("REG_MFG_UID: " + hex(val))

val = read_register(REG_DIE_UID)
print("REG_DIE_UID: " + hex(val))

val = read_register(REG_CONFIG)
print("REG_CONFIG: " + hex(val))

val = read_register(REG_MASK_ENABLE)
print("REG_MASK_ENABLE: " + hex(val))

val = read_register(REG_ALERT_LIMIT)
print("REG_ALERT_LIMIT: " + hex(val))

val = read_register(REG_CURRENT)
print("REG_CURRENT: " + hex(val) + ' ' + str(val))
current = raw_to_amps(val)

val = read_register(REG_BUSVOLTAGE)
print("REG_BUSVOLTAGE: " + hex(val) + ' ' + str(val))
voltage = raw_to_volts(val)

val = read_register(REG_POWER)
print("REG_POWER: " + hex(val) + ' ' + str(val))
power = raw_to_watts(val)
